...
# 2. Rust 包版本
src-tauri/Cargo.toml       →  version = "1.0.4"
...
2. **版本号展示位置**：
   - 窗口标题栏：`IPSwitcher v1.0.4`
   - 欢迎页面：`v1.0.4` 显示在欢迎文本下方
   - 底部状态栏：`v1.0.4` 显示在状态信息右侧
