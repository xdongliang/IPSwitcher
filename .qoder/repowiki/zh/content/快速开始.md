...
## 更新摘要
**所做更改**
- 新增完整的Tauri 2.0开发环境设置说明
- 添加Rust工具链安装和配置的详细步骤
- 更新环境要求部分，包含具体的版本要求
- 增强开发服务器启动和构建流程说明
- 添加平台特定的开发环境配置
- **新增版本号同步管理指南**：详细说明在src-tauri/tauri.conf.json、src-tauri/Cargo.toml和package.json中同步更新版本号的步骤，以及版本号在前端显示的实现方式
...
2. **版本号展示位置**：
   - 窗口标题栏：`IPSwitcher v1.0.1`
   - 欢迎页面：`v1.0.1` 显示在欢迎文本下方
   - 底部状态栏：`v1.0.1` 显示在状态信息右侧
